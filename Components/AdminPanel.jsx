        ...
        <div className="col-span-6">
          {
            activeTab === 1 ?
                ...
                <div className='bg-slate-900 py-10 w-full rounded px-10'>
                  ...
                  <button className='px-4 py-2 btn-primary rounded font-semibold ms-2' onClick={(e) => { e.preventDefault(); setOpenTab('') }}>View Product</button>
                  {
                    openTab === '' ?
                      <ul className='mt-5'>
                        <li>
                          <ProductList product={product} setOpenTab={setOpenTab} setId={setId}/>
                        </li>
                      </ul> :
                      openTab === 'add-product' ?
                        <ProductForm />
              ...
              activeTab === 5 ?
                (
                  <div className='bg-slate-900 py-10 w-full rounded px-10'>
                    <button className='px-4 py-2 btn-primary rounded font-semibold' onClick={(e) => { e.preventDefault(); setOpenTab('add-article') }}>Add Article</button>
                    <button className='px-4 py-2 btn-primary rounded font-semibold ms-2' onClick={(e) => { e.preventDefault(); setOpenTab('') }}>View Article</button>
                    {
                      openTab === '' ?
                        <ul className='mt-5'>
                          <li>
                            <ArticleList article={''} setOpenTab={setOpenTab} setId={setId}/>
                          </li>
                        </ul> :
                        openTab === 'add-article' ?
                          <ArticleForm />
                          :
                          openTab === 'update-article' ?
                            <ArticleForm id={id} />
                            :''
                    }
                  </div>
